An interactive presentation about strange TypeScript stuff.

[Go to the presentation](https://code.hmil.fr/fun-with-types/).

![fun with types](https://code.hmil.fr/fun-with-types/imgs/fun-with-flags.png)
